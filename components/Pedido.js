...
const Pedido = ({ pedido }) => {
  ...
  //TODO Mutation para cambiar el estado de un pedido
  ...
  //TODO Función que modifica el color del pedido de acuerdo a su estado
  const clasePedido = () => {
  ...
  const confirmarEliminarPedido = () => {
    Swal.fire({
      title: "Está seguro que desea eliminar a este pedido?",
  ...
  return (
    <div
      className={`${clase} border-t-4 mt-4 bg-white rounded p-6 md:grid md:grid-cols-2 md:gap-4 shadow-lq`}
    >
      <div>
